...
2. ONNX computational graphs (Opset 17/18) with dynamic shapes
...
from scripts.export_wasm import export_models_for_wasm
...
def main():
    ...
    export_root = PROJECT_ROOT.parent / "crates" / "inference" / "data"
