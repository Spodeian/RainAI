...
from src.models.ddsp import DifferentiableReverbEngine
from src.models.diff_autoencoder import HierarchicalMultiResLoss, BidirectionalMambaBlock
from src.models.mamba2_moe import Mamba2MoETrajectory, JambaSelfAttentionBlock
from src.data.dataset import ActiveLearningSampler
from scripts.train_vae import ModelEMA
...
def test_01_instantaneous_phase_loss():
    ...
    assert loss_zero.item() < 1e-4
    
    x_pert = -x_true
    loss_pert = phase_fn(x_pert, x_true)
    assert loss_pert.item() > 0.5
